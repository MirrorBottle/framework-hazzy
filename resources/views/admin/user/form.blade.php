...
<div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
    ...
    <div>
        ...
        <input type="text" name="name" id="name" class="form-input" value="{{ $data ? $data->name : '' }}" required>
    </div>
    <div>
        <label for="email" class="form-label">Email</label>
        <input type="email" name="email" id="email" class="form-input" value="{{ $data ? $data->email : '' }}" required>
    </div>
    <div>
        <label for="phone_number" class="form-label">No. HP</label>
        <input type="text" name="phone_number" id="phone_number" class="form-input" value="{{ $data ? $data->phone_number : '' }}" required>
    </div>
    <div>
