<div class="sticky top-0 z-[1000] block bg-neutral py-3 lg:block">
    <div class="px-5 md:px-10">
        <div
            ...
            <div class="relative float-right hidden cursor-pointer select-none p-3 text-2xl max-[991px]:z-[9999] max-[991px]:-mr-3 max-[991px]:block max-[991px]:text-white lg:p-[18px]"
                tabindex="0">
                <div class="">
                    <svg width="1.25rem" height="1rem" viewBox="0 0 20 16" fill="none"
