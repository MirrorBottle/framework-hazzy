@extends('auth.layouts.index', ['without_image' => true])
...
@section('content')
    ...
    <form class="space-y-3" action="{{ route('register') }}" method="post">
        ...
        <div>
            ...
            <input type="email" name="email" id="email" class="form-input" placeholder="namamu@perusahaan.com" required>
        </div>
        <div>
        ...
        <div>
            ...
            <input type="text" name="phone_number" id="phone_number" placeholder="+623890128391" class="form-input" required>
        </div>
        <div>
            <label for="company_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Perusahaan</label>
            <input type="text" name="company_name" id="company_name" class="form-input" placeholder="Perusahaanku" required>
        </div>
        <div>
            <label for="company_address" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Alamat</label>
            <input type="text" name="company_address" id="company_address" class="form-input" placeholder="Jl. Sukses No. 4" required>
        </div>
        <div>
            <label for="company_about" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tentang Perusahaan</label>
            <textarea name="company_about" id="company_about" cols="30" rows="3" class="form-input" placeholder="Perusahaanku bergerak di bidang tambang..."></textarea>
        </div>
        <button type="submit"
